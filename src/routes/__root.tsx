...
export const Route = createRootRoute({
  head: () => ({
    meta: [
      ...
      { name: "description", content: "JIMON TORANGY DAILY NECESSITES — корпоративная группа здоровья, продукция ТКМ, БАДы и косметика. 33 года опыта, 4 столетних бренда." },
      { name: "author", content: "JIMON Group" },
      { property: "og:title", content: "JIMON Group — Восточная сила природы для всего мира" },
      { property: "og:description", content: "JIMON TORANGY DAILY NECESSITES — корпоративная группа здоровья, продукция ТКМ, БАДы и косметика. 33 года опыта, 4 столетних бренда." },
